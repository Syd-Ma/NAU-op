...
namespace RhombusApp
{
    public class Rhombus
    {
        ...
        public void PrintCoordinates()
        {
            ...
            Console.WriteLine($"Довжина сторони: {GetSideLength():F0}");
            Console.WriteLine($"Перша діагональ: {GetDiagonal1():F0}");
            Console.WriteLine($"Друга діагональ: {GetDiagonal2():F0}");
            Console.WriteLine($"Периметр: {GetPerimeter():F0}");
            Console.WriteLine($"Площа: {GetArea():F0}");
        }
    }
}
